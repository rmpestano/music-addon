...
public enum  EqualizerPresets {
	...
	CLUB(new float[]{ -1.11022e-15f, -1.11022e-15f, 8.0f, 5.6f, 5.6f, 5.6f, 3.2f, -1.11022e-15f,
			-1.11022e-15f, -1.11022e-15f }),
	DANCE(new float[]{ 9.6f, 7.2f, 2.4f, -1.11022e-15f, -1.11022e-15f, -5.6f, -7.2f, -7.2f,
			-1.11022e-15f, -1.11022e-15f}),
	FULLBASS(new float[]{ -8.0f, 9.6f, 9.6f, 5.6f, 1.6f, -4.0f, -8.0f, -10.4f, -11.2f, -11.2f}),
	HEADPHONES(new float[]{ 4.8f, 11.2f, 5.6f, -3.2f, -2.4f, 1.6f, 4.8f, 9.6f, 12.8f, 14.4f }),

	LARGEHALL(new float[]{10.4f, 10.4f, 5.6f, 5.6f, -1.11022e-15f, -4.8f, -4.8f, -4.8f, -1.11022e-15f,
			-1.11022e-15f}),
	LIVE(new float[]{ -4.8f, -1.11022e-15f, 4.0f, 5.6f, 5.6f, 5.6f, 4.0f, 2.4f, 2.4f, 2.4f}),
	POP(new float[]{ -1.6f, 4.8f, 7.2f, 8.0f, 5.6f, -1.11022e-15f, -2.4f, -2.4f, -1.6f, -1.6f }),
	REGGAE(new float[]{ -1.11022e-15f, -1.11022e-15f, -1.11022e-15f, -5.6f, -1.11022e-15f, 6.4f, 6.4f,
			-1.11022e-15f, -1.11022e-15f, -1.11022e-15f }),
	ROCK(new float[]{ 8.0f, 4.8f, -5.6f, -8.0f, -3.2f, 4.0f, 8.8f, 11.2f, 11.2f, 11.2f }),

	SOFT(new float[]{ 4.8f, 1.6f, -1.11022e-15f, -2.4f, -1.11022e-15f, 4.0f, 8.0f, 9.6f, 11.2f,
			12.0f}),
	SOFT_ROCK(new float[]{  4.0f, 4.0f, 2.4f, -1.11022e-15f, -4.0f, -5.6f, -3.2f, -1.11022e-15f, 2.4f,
			8.8f }),
	TECHNO(new float[]{ 8.0f, 5.6f, -1.11022e-15f, -5.6f, -4.8f, -1.11022e-15f, 8.0f, 9.6f, 9.6f,
			8.8f});

	private final float[] value;


	EqualizerPresets(float[] value) {
		this.value = value;
	}
	...
	public EqualizerPresets(float[] value) {
